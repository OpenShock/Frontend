<script lang="ts">
  ...
  import ChromeLogo from '$core/components/svg/ChromeLogo.svelte';
  import EdgeLogo from '$core/components/svg/EdgeLogo.svelte';
  import OperaLogo from '$core/components/svg/OperaLogo.svelte';
