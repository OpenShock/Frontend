...
import type {
  ...
  DevicesListDevicesResponse,
  DevicesOtaGetOtaUpdateHistoryResponse,
  PublicGetOnlineDevicesStatisticsResponse,
  PublicGetPublicShareResponse,
  SessionsGetSelfSessionResponse,
  SessionsListSessionsResponse,
  ShareLinksListResponse,
  ShockerGetAllShockerLogsResponse,
  ShockerGetShockerByIdResponse,
  ShockerGetShockerLogsResponse,
  ShockerGetUserSharesResponse,
  ShockerListShockersResponse,
  ShockerShockerShareCodeListResponse,
  TokensCreateTokenResponse,
  TokensGetTokenByIdResponse,
  TokensListTokensResponse,
  TokensSelfGetSelfTokenResponse,
...
export const tokensGetTokenByIdResponseTransformer = async (
  data: any
): Promise<TokensGetTokenByIdResponse> => {
  data = tokenResponseSchemaResponseTransformer(data);
  return data;
};

export const tokensSelfGetSelfTokenResponseTransformer = async (
  data: any
): Promise<TokensSelfGetSelfTokenResponse> => {
  data = tokenResponseSchemaResponseTransformer(data);
  return data;
};

export const tokensListTokensResponseTransformer = async (
  data: any
): Promise<TokensListTokensResponse> => {
...
export const tokensCreateTokenResponseTransformer = async (
  data: any
...
export const adminConfigurationListResponseTransformer = async (
  data: any
...
export const adminGetEmailOutboxStatsResponseTransformer = async (
  data: any
): Promise<AdminGetEmailOutboxStatsResponse> => {
  data = emailOutboxStatsDtoSchemaResponseTransformer(data);
  return data;
};

export const adminSendTestEmailResponseTransformer = async (
  data: any
): Promise<AdminSendTestEmailResponse> => {
...
export const adminListEmailProviderBlacklistResponseTransformer = async (
  data: any
...
export const adminListUsernameBlacklistResponseTransformer = async (
  data: any
): Promise<AdminListUsernameBlacklistResponse> => {
...
export const adminListWebhooksResponseTransformer = async (
  data: any
