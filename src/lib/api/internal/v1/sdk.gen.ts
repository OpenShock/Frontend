 ...
 */
export const accountPasswordResetCheckValid = <ThrowOnError extends boolean = true>(options: Options<AccountPasswordResetCheckValidData, ThrowOnError>) => (options.client ?? client).get<AccountPasswordResetCheckValidResponses, AccountPasswordResetCheckValidErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
 ...
 * @deprecated
 */
export const accountPasswordResetCheckValidLegacy = <ThrowOnError extends boolean = true>(options: Options<AccountPasswordResetCheckValidLegacyData, ThrowOnError>) => (options.client ?? client).head<AccountPasswordResetCheckValidLegacyResponses, AccountPasswordResetCheckValidLegacyErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
 ...
 * @deprecated
 */
export const accountPasswordResetCompleteLegacy = <ThrowOnError extends boolean = true>(options: Options<AccountPasswordResetCompleteLegacyData, ThrowOnError>) => (options.client ?? client).post<AccountPasswordResetCompleteLegacyResponses, AccountPasswordResetCompleteLegacyErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
    url: '/1/account/recover/{passwordResetId}/{secret}',
    ...options,
    headers: {
 ...
 * @deprecated
 */
export const accountEmailVerifyLegacy = <ThrowOnError extends boolean = true>(options?: Options<AccountEmailVerifyLegacyData, ThrowOnError>) => (options?.client ?? client).post<AccountEmailVerifyLegacyResponses, AccountEmailVerifyLegacyErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
 ...
 */
export const authenticatedAccountChangeEmail = <ThrowOnError extends boolean = true>(options?: Options<AuthenticatedAccountChangeEmailData, ThrowOnError>) => (options?.client ?? client).post<AuthenticatedAccountChangeEmailResponses, AuthenticatedAccountChangeEmailErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
